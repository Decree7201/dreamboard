...
deploy_cloud_run_service() {
    ...
    --set-env-vars PROJECT_ID=$GOOGLE_CLOUD_PROJECT,LOCATION=$LOCATION,GCS_BUCKET=$BUCKET_NAME,FIRESTORE_DB=$FIRESTORE_DB,USE_AUTH_MIDDLEWARE=True,USE_PREVIEW_VIDEO_MODEL=True,USE_PREVIEW_GEMINI_IMAGE_MODEL=True,USE_PREVIEW_GEMINI_IMAGE_MODEL=True,GEMINI_IMAGE_MODEL_LOCATION="global",USE_PREVIEW_GEMINI_MODEL=True,GEMINI_MODEL_LOCATION="global"
    echo
}
